#!/usr/bin/env python3
"""Run Nevada HOA ingestion end-to-end.
...
## Placeholders to replace before use
  ...
  NV             Two-letter state code, e.g. "MT"
  Nevada        Full state name, e.g. "Montana"
  {"max_lat": 42.0, "max_lon": -114.04, "min_lat": 35.0, "min_lon": -120.01}        Dict with min_lat/max_lat/min_lon/max_lon for OOB check
...
STATE_BBOX: dict[str, float] = {"max_lat": 42.0, "max_lon": -114.04, "min_lat": 35.0, "min_lon": -120.01}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("nv_clark_serper_queries.txt", "Clark"),
    ("nv_washoe_serper_queries.txt", "Washoe"),
    ("nv_carson-city_serper_queries.txt", "Carson City"),
    ("nv_lyon_serper_queries.txt", "Lyon"),
    ("nv_douglas_serper_queries.txt", "Douglas"),
    ("nv_elko_serper_queries.txt", "Elko"),
    ("nv_vegas_communities_serper_queries.txt", "Clark"),
    ("nv_host_family_serper_queries.txt", None),
]
