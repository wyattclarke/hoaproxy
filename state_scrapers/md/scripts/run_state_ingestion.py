...
STATE = "MD"
STATE_NAME = "Maryland"
STATE_BBOX: dict[str, float] = {"min_lat": 37.89, "max_lat": 39.72, "min_lon": -79.49, "max_lon": -75.05}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("md_montgomery_md_serper_queries.txt", "Montgomery"),
    ("md_prince_georges_serper_queries.txt", "Prince George's"),
    ("md_baltimore_md_serper_queries.txt", "Baltimore"),
    ("md_baltimore_city_serper_queries.txt", "Baltimore City"),
    ("md_anne_arundel_serper_queries.txt", "Anne Arundel"),
    ("md_howard_serper_queries.txt", "Howard"),
    ("md_frederick_md_serper_queries.txt", "Frederick"),
    ("md_harford_serper_queries.txt", "Harford"),
    ("md_charles_serper_queries.txt", "Charles"),
    ("md_worcester_md_serper_queries.txt", "Worcester"),
    ("md_st_marys_serper_queries.txt", "St. Mary's"),
]
