...
STATE = "OH"
STATE_NAME = "Ohio"
STATE_BBOX: dict[str, float] = {"min_lat": 38.4, "max_lat": 42.0, "min_lon": -84.82, "max_lon": -80.52}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("oh_cuyahoga_serper_queries.txt", "Cuyahoga"),
    ("oh_franklin_oh_serper_queries.txt", "Franklin"),
    ("oh_hamilton_oh_serper_queries.txt", "Hamilton"),
    ("oh_summit_oh_serper_queries.txt", "Summit"),
    ("oh_montgomery_oh_serper_queries.txt", "Montgomery"),
    ("oh_lucas_serper_queries.txt", "Lucas"),
    ("oh_stark_oh_serper_queries.txt", "Stark"),
    ("oh_butler_oh_serper_queries.txt", "Butler"),
    ("oh_lake_serper_queries.txt", "Lake"),
    ("oh_warren_oh_serper_queries.txt", "Warren"),
    ("oh_delaware_oh_serper_queries.txt", "Delaware"),
    ("oh_medina_serper_queries.txt", "Medina"),
]
