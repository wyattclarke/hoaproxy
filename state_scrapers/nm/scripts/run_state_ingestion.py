...
STATE_BBOX: dict[str, float] = {"min_lat": 31.33, "max_lat": 37.0, "min_lon": -109.05, "max_lon": -103.0}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("nm_bernalillo_serper_queries.txt", "Bernalillo"),
    ("nm_sandoval_serper_queries.txt", "Sandoval"),
    ("nm_dona_ana_serper_queries.txt", "Doña Ana"),
    ("nm_santa_fe_serper_queries.txt", "Santa Fe"),
    ("nm_san_juan_serper_queries.txt", "San Juan"),
    ("nm_lea_serper_queries.txt", "Lea"),
    ("nm_otero_serper_queries.txt", "Otero"),
    ("nm_chaves_serper_queries.txt", "Chaves"),
    ("nm_lincoln_nm_serper_queries.txt", "Lincoln"),
    ("nm_eddy_serper_queries.txt", "Eddy"),
    ("nm_mckinley_serper_queries.txt", "McKinley"),
    ("nm_curry_serper_queries.txt", "Curry"),
    ("nm_valencia_serper_queries.txt", "Valencia"),
    ("nm_taos_serper_queries.txt", "Taos"),
]
