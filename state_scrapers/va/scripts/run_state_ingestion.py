...
STATE_BBOX: dict[str, float] = {"min_lat": 36.54, "max_lat": 39.47, "min_lon": -83.68, "max_lon": -75.24}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("va_fairfax_serper_queries.txt", "Fairfax"),
    ("va_virginia-beach_serper_queries.txt", "Virginia Beach"),
    ("va_prince-william_serper_queries.txt", "Prince William"),
    ("va_loudoun_serper_queries.txt", "Loudoun"),
    ("va_henrico_serper_queries.txt", "Henrico"),
    ("va_chesterfield_serper_queries.txt", "Chesterfield"),
    ("va_norfolk_serper_queries.txt", "Norfolk"),
    ("va_chesapeake_serper_queries.txt", "Chesapeake"),
    ("va_arlington_serper_queries.txt", "Arlington"),
    ("va_stafford_serper_queries.txt", "Stafford"),
    ("va_spotsylvania_serper_queries.txt", "Spotsylvania"),
    ("va_james-city_serper_queries.txt", "James City"),
