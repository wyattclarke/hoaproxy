...
STATE = "AR"
STATE_NAME = "Arkansas"
STATE_BBOX: dict[str, float] = {"min_lat": 33.0, "max_lat": 36.5, "min_lon": -94.62, "max_lon": -89.64}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("ar_pulaski_serper_queries.txt", "Pulaski"),
    ("ar_benton_serper_queries.txt", "Benton"),
    ("ar_washington_serper_queries.txt", "Washington"),
    ("ar_faulkner_serper_queries.txt", "Faulkner"),
    ("ar_saline_serper_queries.txt", "Saline"),
    ("ar_garland_serper_queries.txt", "Garland"),
    ("ar_sebastian_serper_queries.txt", "Sebastian"),
    ("ar_craighead_serper_queries.txt", "Craighead"),
    ("ar_lonoke_serper_queries.txt", "Lonoke"),
    ("ar_white_serper_queries.txt", "White"),
    ("ar_crittenden_serper_queries.txt", "Crittenden"),
    ("ar_pope_serper_queries.txt", "Pope"),
    ("ar_crawford_serper_queries.txt", "Crawford"),
    ("ar_hot_spring_serper_queries.txt", "Hot Spring"),
    ("ar_jefferson_ar_serper_queries.txt", "Jefferson"),
    ("ar_independence_serper_queries.txt", "Independence"),
]
