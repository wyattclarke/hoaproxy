...
run_import_to_live() {
    ...
    # Prefer explicit HOAPROXY_ADMIN_BEARER, fall back to local JWT_SECRET.
    # The Render env-vars fetch that used to sit between these was removed
    # 2026-05-16 (Hetzner cutover).
