...
STATE = "MI"
STATE_NAME = "Michigan"
STATE_BBOX: dict[str, float] = {"min_lat": 41.7, "max_lat": 48.31, "min_lon": -90.42, "max_lon": -82.12}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("mi_wayne_mi_serper_queries.txt", "Wayne"),
    ("mi_oakland_serper_queries.txt", "Oakland"),
    ("mi_macomb_serper_queries.txt", "Macomb"),
    ("mi_kent_mi_serper_queries.txt", "Kent"),
    ("mi_washtenaw_serper_queries.txt", "Washtenaw"),
    ("mi_genesee_serper_queries.txt", "Genesee"),
    ("mi_ingham_serper_queries.txt", "Ingham"),
    ("mi_kalamazoo_serper_queries.txt", "Kalamazoo"),
    ("mi_ottawa_mi_serper_queries.txt", "Ottawa"),
    ("mi_saginaw_mi_serper_queries.txt", "Saginaw"),
    ("mi_grand_traverse_serper_queries.txt", "Grand Traverse"),
    ("mi_emmet_serper_queries.txt", "Emmet"),
]
