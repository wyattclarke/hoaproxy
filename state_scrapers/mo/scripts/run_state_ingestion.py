...
STATE = "MO"
STATE_NAME = "Missouri"
STATE_BBOX: dict[str, float] = {"min_lat": 35.99, "max_lat": 40.61, "min_lon": -95.77, "max_lon": -89.1}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("mo_st_louis_mo_serper_queries.txt", "St. Louis"),
    ("mo_st_louis_city_serper_queries.txt", "St. Louis City"),
    ("mo_jackson_mo_serper_queries.txt", "Jackson"),
    ("mo_st_charles_serper_queries.txt", "St. Charles"),
    ("mo_greene_mo_serper_queries.txt", "Greene"),
    ("mo_boone_mo_serper_queries.txt", "Boone"),
    ("mo_clay_mo_serper_queries.txt", "Clay"),
    ("mo_platte_serper_queries.txt", "Platte"),
    ("mo_jefferson_mo_serper_queries.txt", "Jefferson"),
    ("mo_franklin_mo_serper_queries.txt", "Franklin"),
    ("mo_lake_of_the_ozarks_camden_serper_queries.txt", "Camden"),
]
