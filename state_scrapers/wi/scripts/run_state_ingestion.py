...
STATE_BBOX: dict[str, float] = {"min_lat": 42.49, "max_lat": 47.08, "min_lon": -92.89, "max_lon": -86.25}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("wi_milwaukee_wi_serper_queries.txt", "Milwaukee"),
    ("wi_dane_serper_queries.txt", "Dane"),
    ("wi_waukesha_serper_queries.txt", "Waukesha"),
    ("wi_brown_wi_serper_queries.txt", "Brown"),
    ("wi_racine_serper_queries.txt", "Racine"),
    ("wi_kenosha_serper_queries.txt", "Kenosha"),
    ("wi_winnebago_serper_queries.txt", "Winnebago"),
    ("wi_outagamie_serper_queries.txt", "Outagamie"),
    ("wi_washington_wi_serper_queries.txt", "Washington"),
    ("wi_ozaukee_serper_queries.txt", "Ozaukee"),
    ("wi_door_serper_queries.txt", "Door"),
    ("wi_walworth_serper_queries.txt", "Walworth"),
]
