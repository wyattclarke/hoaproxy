...
STATE_BBOX: dict[str, float] = {"min_lat": 38.87, "max_lat": 41.36, "min_lon": -75.56, "max_lon": -73.87}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("nj_bergen_serper_queries.txt", "Bergen"),
    ("nj_middlesex_nj_serper_queries.txt", "Middlesex"),
    ("nj_essex_nj_serper_queries.txt", "Essex"),
    ("nj_hudson_serper_queries.txt", "Hudson"),
    ("nj_monmouth_serper_queries.txt", "Monmouth"),
    ("nj_ocean_serper_queries.txt", "Ocean"),
    ("nj_morris_serper_queries.txt", "Morris"),
    ("nj_camden_serper_queries.txt", "Camden"),
    ("nj_burlington_serper_queries.txt", "Burlington"),
    ("nj_passaic_serper_queries.txt", "Passaic"),
    ("nj_atlantic_serper_queries.txt", "Atlantic"),
    ("nj_cape_may_serper_queries.txt", "Cape May"),
    ("nj_somerset_nj_serper_queries.txt", "Somerset"),
    ("nj_union_serper_queries.txt", "Union"),
]
...
def main() -> int:
    ...
    parser.add_argument("--max-docai-cost-usd", type=float, default=60.0,
