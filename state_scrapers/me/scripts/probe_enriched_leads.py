...
def main() -> int:
    ...
    p.add_argument("--input", default=str(ROOT / "state_scrapers/me/leads/me_curated_direct_pdf_leads.jsonl"))
    p.add_argument("--output", default=str(ROOT / "state_scrapers/me/leads/me_probe_results.jsonl"))
