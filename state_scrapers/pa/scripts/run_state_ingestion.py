...
STATE_BBOX: dict[str, float] = {"min_lat": 39.72, "max_lat": 42.27, "min_lon": -80.52, "max_lon": -74.69}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("pa_philadelphia_serper_queries.txt", "Philadelphia"),
    ("pa_allegheny_serper_queries.txt", "Allegheny"),
    ("pa_montgomery_pa_serper_queries.txt", "Montgomery"),
    ("pa_bucks_serper_queries.txt", "Bucks"),
    ("pa_chester_serper_queries.txt", "Chester"),
    ("pa_delaware_pa_serper_queries.txt", "Delaware"),
    ("pa_lancaster_serper_queries.txt", "Lancaster"),
    ("pa_lehigh_serper_queries.txt", "Lehigh"),
    ("pa_berks_serper_queries.txt", "Berks"),
    ("pa_york_pa_serper_queries.txt", "York"),
    ("pa_cumberland_pa_serper_queries.txt", "Cumberland"),
    ("pa_monroe_pa_serper_queries.txt", "Monroe"),
]
