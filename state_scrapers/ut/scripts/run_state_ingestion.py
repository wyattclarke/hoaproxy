#!/usr/bin/env python3
"""Run Utah HOA ingestion end-to-end.
...
## Placeholders to replace before use
  ...
  UT             Two-letter state code, e.g. "MT"
  Utah        Full state name, e.g. "Montana"
  {"max_lat": 42.0, "max_lon": -109.04, "min_lat": 36.99, "min_lon": -114.05}        Dict with min_lat/max_lat/min_lon/max_lon for OOB check
...
STATE_BBOX: dict[str, float] = {"max_lat": 42.0, "max_lon": -109.04, "min_lat": 36.99, "min_lon": -114.05}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("ut_salt-lake_serper_queries.txt", "Salt Lake"),
    ("ut_utah_serper_queries.txt", "Utah"),
    ("ut_davis_serper_queries.txt", "Davis"),
    ("ut_weber_serper_queries.txt", "Weber"),
    ("ut_washington_serper_queries.txt", "Washington"),
    ("ut_cache_serper_queries.txt", "Cache"),
    ("ut_tooele_serper_queries.txt", "Tooele"),
    ("ut_iron_serper_queries.txt", "Iron"),
    ("ut_box-elder_serper_queries.txt", "Box Elder"),
    ("ut_summit_serper_queries.txt", "Summit"),
    ("ut_wasatch_serper_queries.txt", "Wasatch"),
    ("ut_host_family_serper_queries.txt", None),
]
