...
STATE_BBOX: dict[str, float] = {"min_lat": 37.2, "max_lat": 40.65, "min_lon": -82.65, "max_lon": -77.72}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("wv_kanawha_serper_queries.txt", "Kanawha"),
    ("wv_berkeley_serper_queries.txt", "Berkeley"),
    ("wv_monongalia_serper_queries.txt", "Monongalia"),
    ("wv_cabell_serper_queries.txt", "Cabell"),
    ("wv_marshall_serper_queries.txt", "Marshall"),
    ("wv_ohio_serper_queries.txt", "Ohio"),
    ("wv_wood_serper_queries.txt", "Wood"),
    ("wv_harrison_serper_queries.txt", "Harrison"),
    ("wv_mercer_serper_queries.txt", "Mercer"),
    ("wv_raleigh_serper_queries.txt", "Raleigh"),
    ("wv_jefferson_wv_serper_queries.txt", "Jefferson"),
    ("wv_putnam_serper_queries.txt", "Putnam"),
    ("wv_mineral_serper_queries.txt", "Mineral"),
    ("wv_greenbrier_serper_queries.txt", "Greenbrier"),
    ("wv_pocahontas_serper_queries.txt", "Pocahontas"),
]
