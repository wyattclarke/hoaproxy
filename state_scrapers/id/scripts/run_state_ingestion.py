#!/usr/bin/env python3
"""Run Idaho HOA ingestion end-to-end.
...
## Placeholders to replace before use
  ...
  ID             Two-letter state code, e.g. "MT"
  Idaho        Full state name, e.g. "Montana"
  {"max_lat": 49.0, "max_lon": -111.04, "min_lat": 41.99, "min_lon": -117.24}        Dict with min_lat/max_lat/min_lon/max_lon for OOB check
...
STATE_BBOX: dict[str, float] = {"max_lat": 49.0, "max_lon": -111.04, "min_lat": 41.99, "min_lon": -117.24}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("id_ada_serper_queries.txt", "Ada"),
    ("id_canyon_serper_queries.txt", "Canyon"),
    ("id_kootenai_serper_queries.txt", "Kootenai"),
    ("id_bonneville_serper_queries.txt", "Bonneville"),
    ("id_twin-falls_serper_queries.txt", "Twin Falls"),
    ("id_bannock_serper_queries.txt", "Bannock"),
    ("id_madison_serper_queries.txt", "Madison"),
    ("id_blaine_serper_queries.txt", "Blaine"),
    ("id_bonner_serper_queries.txt", "Bonner"),
    ("id_host_family_serper_queries.txt", None),
]
