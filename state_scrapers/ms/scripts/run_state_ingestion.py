...
STATE_BBOX: dict[str, float] = {"min_lat": 30.17, "max_lat": 34.99, "min_lon": -91.66, "max_lon": -88.1}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("ms_hinds_serper_queries.txt", "Hinds"),
    ("ms_madison_serper_queries.txt", "Madison"),
    ("ms_rankin_serper_queries.txt", "Rankin"),
    ("ms_desoto_serper_queries.txt", "DeSoto"),
    ("ms_harrison_serper_queries.txt", "Harrison"),
    ("ms_lee_serper_queries.txt", "Lee"),
    ("ms_lauderdale_serper_queries.txt", "Lauderdale"),
    ("ms_lamar_serper_queries.txt", "Lamar"),
    ("ms_forrest_serper_queries.txt", "Forrest"),
    ("ms_jackson_serper_queries.txt", "Jackson"),
    ("ms_lowndes_serper_queries.txt", "Lowndes"),
    ("ms_pike_serper_queries.txt", "Pike"),
    ("ms_warren_serper_queries.txt", "Warren"),
    ("ms_lafayette_serper_queries.txt", "Lafayette"),
    ("ms_pontotoc_serper_queries.txt", "Pontotoc"),
    ("ms_coahoma_serper_queries.txt", "Coahoma"),
]
