...
STATE_BBOX: dict[str, float] = {"min_lat": 45.54, "max_lat": 49.00, "min_lon": -124.85, "max_lon": -116.92}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("wa_king_serper_queries.txt", "King"),
    ("wa_pierce_serper_queries.txt", "Pierce"),
    ("wa_snohomish_serper_queries.txt", "Snohomish"),
    ("wa_spokane_serper_queries.txt", "Spokane"),
    ("wa_clark_serper_queries.txt", "Clark"),
    ("wa_thurston_serper_queries.txt", "Thurston"),
    ("wa_kitsap_serper_queries.txt", "Kitsap"),
    ("wa_whatcom_serper_queries.txt", "Whatcom"),
    ("wa_yakima_serper_queries.txt", "Yakima"),
    ("wa_benton_serper_queries.txt", "Benton"),
    ("wa_skagit_serper_queries.txt", "Skagit"),
    ("wa_chelan_serper_queries.txt", "Chelan"),
    ("wa_host_family_serper_queries.txt", None),
]
