...
STATE_BBOX: dict[str, float] = {"min_lat": 43.5, "max_lat": 49.38, "min_lon": -97.24, "max_lon": -89.49}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("mn_hennepin_serper_queries.txt", "Hennepin"),
    ("mn_ramsey_mn_serper_queries.txt", "Ramsey"),
    ("mn_dakota_mn_serper_queries.txt", "Dakota"),
    ("mn_anoka_serper_queries.txt", "Anoka"),
    ("mn_washington_mn_serper_queries.txt", "Washington"),
    ("mn_wright_mn_serper_queries.txt", "Wright"),
    ("mn_olmsted_serper_queries.txt", "Olmsted"),
    ("mn_st_louis_mn_serper_queries.txt", "St. Louis"),
    ("mn_stearns_serper_queries.txt", "Stearns"),
    ("mn_scott_mn_serper_queries.txt", "Scott"),
    ("mn_carver_serper_queries.txt", "Carver"),
]
