...
STATE = "OR"
STATE_NAME = "Oregon"
STATE_BBOX: dict[str, float] = {"min_lat": 41.99, "max_lat": 46.29, "min_lon": -124.57, "max_lon": -116.46}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("or_multnomah_serper_queries.txt", "Multnomah"),
    ("or_washington_or_serper_queries.txt", "Washington"),
    ("or_clackamas_serper_queries.txt", "Clackamas"),
    ("or_marion_or_serper_queries.txt", "Marion"),
    ("or_lane_serper_queries.txt", "Lane"),
    ("or_jackson_or_serper_queries.txt", "Jackson"),
    ("or_deschutes_or_serper_queries.txt", "Deschutes"),
    ("or_linn_or_serper_queries.txt", "Linn"),
    ("or_polk_or_serper_queries.txt", "Polk"),
    ("or_yamhill_serper_queries.txt", "Yamhill"),
    ("or_benton_or_serper_queries.txt", "Benton"),
    ("or_hood_river_serper_queries.txt", "Hood River"),
]
