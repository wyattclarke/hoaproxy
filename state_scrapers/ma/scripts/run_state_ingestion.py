...
STATE_BBOX: dict[str, float] = {"min_lat": 41.18, "max_lat": 42.89, "min_lon": -73.51, "max_lon": -69.86}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("ma_middlesex_serper_queries.txt", "Middlesex"),
    ("ma_suffolk_serper_queries.txt", "Suffolk"),
    ("ma_worcester_serper_queries.txt", "Worcester"),
    ("ma_essex_ma_serper_queries.txt", "Essex"),
    ("ma_norfolk_ma_serper_queries.txt", "Norfolk"),
    ("ma_bristol_ma_serper_queries.txt", "Bristol"),
    ("ma_plymouth_serper_queries.txt", "Plymouth"),
    ("ma_barnstable_serper_queries.txt", "Barnstable"),
    ("ma_hampden_serper_queries.txt", "Hampden"),
    ("ma_berkshire_serper_queries.txt", "Berkshire"),
    ("ma_nantucket_serper_queries.txt", "Nantucket"),
    ("ma_dukes_serper_queries.txt", "Dukes"),
]
