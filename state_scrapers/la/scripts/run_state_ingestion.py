#!/usr/bin/env python3
"""Run Louisiana HOA ingestion end-to-end.
...
## Placeholders to replace before use
  ...
  LA             Two-letter state code, e.g. "MT"
  Louisiana        Full state name, e.g. "Montana"
  {"max_lat": 33.02, "max_lon": -88.81, "min_lat": 28.93, "min_lon": -94.04}        Dict with min_lat/max_lat/min_lon/max_lon for OOB check
...
# ---------------------------------------------------------------------------
STATE = "LA"           # e.g. "MT"
STATE_NAME = "Louisiana" # e.g. "Montana"
...
STATE_BBOX: dict[str, float] = {"max_lat": 33.02, "max_lon": -88.81, "min_lat": 28.93, "min_lon": -94.04}
# ---------------------------------------------------------------------------
...
COUNTY_RUNS: list[tuple[str, str | None]] = [
    ("la_east-baton-rouge_serper_queries.txt", "East Baton Rouge"),
    ("la_jefferson_serper_queries.txt", "Jefferson"),
    ("la_orleans_serper_queries.txt", "Orleans"),
    ("la_st-tammany_serper_queries.txt", "St. Tammany"),
    ("la_lafayette_serper_queries.txt", "Lafayette"),
    ("la_caddo_serper_queries.txt", "Caddo"),
    ("la_calcasieu_serper_queries.txt", "Calcasieu"),
    ("la_ouachita_serper_queries.txt", "Ouachita"),
    ("la_livingston_serper_queries.txt", "Livingston"),
    ("la_rapides_serper_queries.txt", "Rapides"),
    ("la_tangipahoa_serper_queries.txt", "Tangipahoa"),
    ("la_ascension_serper_queries.txt", "Ascension"),
    ("la_bossier_serper_queries.txt", "Bossier"),
    ("la_terrebonne_serper_queries.txt", "Terrebonne"),
    ("la_lafourche_serper_queries.txt", "Lafourche"),
    ("la_iberia_serper_queries.txt", "Iberia"),
    ("la_host_family_serper_queries.txt", None),
]
