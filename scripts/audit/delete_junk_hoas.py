...
def live_admin_token() -> str | None:
    # Explicit override wins; otherwise pull from settings.env (loaded above).
    # The Render env-vars API was used pre-migration as the source of truth
    # for JWT_SECRET — removed 2026-05-16 when the Render service was
    # suspended after the Hetzner cutover.
